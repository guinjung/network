...
---
```
[im@192.168.0.31 ~/gij]$ cat ./check_ports.sh
echo "포트 사용 상태 확인 중..."
v_cnt=0
for v_port in $1 $2 $3 $4 $5
do
        if lsof -i :$v_port > /dev/null ; then
                echo "$v_port : 사용 중"
                v_cnt=$((v_cnt + 1))
        else
                echo "$v_port : 사용안함"
...
echo "총 5개 포트 중 $v_cnt개가 사용 중입니다."

[im@192.168.0.31 ~/gij]$ ./check_ports.sh 80 5000 5050 7000 10000
포트 사용 상태 확인 중...
80 : 사용안함
5000 : 사용 중
5050 : 사용 중
